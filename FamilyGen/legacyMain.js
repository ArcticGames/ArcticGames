  ...
  if(input[0]=='info'){
    ...
    if(people.length==0){
      ...
      if(input[1]=='alive'){
        ...
        list.forEach(function(element){
          if(people[element].dead!==true){
            if(people[element].age==1){
              console_out(element+' is currently ' + people[element].age.toString().green + ' year old.')
              i++
            }else{
        ...
        if(i==1){
          console_out('There is currently '+ i.toString().cyan+' person alive.')
        }else if (i==0) {
          console_out('There is currently '+'no one'.cyan+' alive');
        }else{
          console_out('There are currently '+i.toString().cyan+' people alive.')
        }
      }else{
        list.forEach(function(element){
          if(people[element].dead==true){
        ...
        if(list.length==1){
          console_out('There is currently '+list.length.toString().cyan+' entry in the list.');
        }else{
          console_out('There are currently '+list.length.toString().cyan+' entries in the list.');
        }
      };
    }
    console_out('-----------------------------------------------'.green);
